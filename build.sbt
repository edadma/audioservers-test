...
mainClass in (Compile, run) := Some( "xyz.hyperreal." + name.value.replace('-', '_') + ".SineAudioClient" )

mainClass in assembly := Some( "xyz.hyperreal." + name.value.replace('-', '_') + ".SineAudioClient" )
